...
| Contract Template | `docs/contract_template.docx` | Listing agreement + lead referral fee agreement templates |
| Sales Deck | `docs/payhome_sales_deck.pptx` | B2B sales presentation (12 slides) |
