...
## 🔥 収益ドリブン機能優先順位（2026-03-26更新）

1億円達成に向けた機能優先順位。売上インパクトの大きい順に実装する。

### 最優先（5月リリース前）
- F-01〜F-06：基本フォーム・通知・AIチャットの本番稼働
- F-04：**50社分の実データ投入**（これがないと全収益がゼロ）

### 高優先（5月中）
- **F-07：まとめて資料請求（年間+960万円）**
- **F-08：見学会残席表示＋今週末特集（年間+1,920万円）**
- F-09：工務店比較機能
- F-10：フィルター検索

### 中優先（6〜7月）
- F-12：消費者フォローメール自動配信（年間+500万円）
- F-13：OBの声セクション
- F-14：AIチャット→工務店推薦

### 後回し（8月以降）
- F-17〜F-23：GA4・ダッシュボード・AI高度化
