...
**最終更新:** 2026-04-12 (v4.1 パッチ)

> **v4.1 パッチ (2026-04-12):**
> - 比較機能 (`/builders/compare`) を MVP 非公開に変更。Phase 3 で復活。
> - 料金モデル v2 反映 (全員同一料金、成果報酬 Phase 3〜)
> - 特集・分譲住宅・土地情報を MVP で公開継続だがグローバルナビ主役から外す (補助導線化)
> - `/welcome` `/mypage/catalog` の middleware 非公開を解除 (バグ修正)
> - 資料請求関連 UI 投資は完全停止 (ナビ・CTA・スコアリングから除外)
