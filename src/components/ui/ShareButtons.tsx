...
export default function ShareButtons() {
  ...
  return (
    <div className="flex items-center gap-3 py-6 border-t border-gray-100">
      <span className="text-sm text-gray-600 font-semibold">この記事をシェア：</span>
      <button
        onClick={shareOnX}
      ...
      <button
        onClick={shareOnLine}
        className="w-10 h-10 flex items-center justify-center rounded-full bg-[#06C755] text-white hover:bg-[#05b34d] transition-colors"
        aria-label="LINEでシェア"
      >
